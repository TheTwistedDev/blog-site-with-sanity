    ...
    <main>
        ...
        <article className="max-w-3xl p-5 mx-auto">
            ...
            <div className="flex items-center space-x-2">
                ...
                <p className="text-sm font-extralight">
                    Blog post by <span className="text-blue-600">{post.author.name}</span> - Published at{' '}
        ...
        {submitted ? (
            ...
            <label className="block mb-5 ">
                ...
                <input {...register("name", { required: true })} className="block w-full py-2 pl-2 mt-1 border rounded shadow outline-none form-input ring-yellow-500 focus:ring"placeholder="John Appleseed" type="text"/>
            </label>

            <label className="block mb-5 ">
                <span className="text-gray-700">Email</span>
                <input {...register("email", { required: true })} className="block w-full py-2 pl-2 mt-1 border rounded shadow outline-none form-input ring-yellow-500 focus:ring" placeholder="JohnAppleseed@email.com" type="email"/>
            </label>

            <label className="block mb-5 ">
                <span className="text-gray-700">Comment</span>
                <textarea {...register("comment", { required: true })} className="block w-full px-3 py-2 pl-2 mt-1 border rounded shadow outline-none form-textarea focus:ring ring-yellow-500" placeholder="John Appleseed" rows={8}/>
            </label>
        ...
        {/* Comments  */}
        <div className="flex flex-col max-w-2xl p-10 mx-auto my-10 space-y-2 border shadow-sm shadow-yellow-500">
            <h3 className="text-4xl">Comments</h3>
            <hr className="pb-2"/>
            {post.comments.map((comment) => (
                <div className="p-2 border shadow-sm" key={comment._id}>
